"""Run fuzzy computed-torque control on the dynamic 2-DOF arm."""
...
def main() -> int:
    ...
    output_path = ROOT / "results" / "figures" / "step_07_fuzzy_dynamic_2dof.png"
    ...
    fig, _ = plot_control_simulation(
        ...
        title="Controle flou dynamique couple calcule - bras 2DDL",
        action_ylabel="N.m",
    )
