"""Run computed-torque fuzzy control on the dynamic 3-DOF arm."""
...
def main() -> int:
    ...
    output_path = ROOT / "results" / "figures" / "step_20_fuzzy_dynamic_3dof.png"
    ...
    fig, _ = plot_control_simulation_3dof(
        ...
        title="Controle flou dynamique - bras 3DDL spatial",
        action_ylabel="N.m",
    )
