"""Run fuzzy gain-scheduled computed-torque PID on the dynamic 5-DOF arm."""
...
def main() -> int:
    ...
    output_path = (
        ROOT / "results" / "figures" / "step_29_pid_fuzzy_gain_dynamic_5dof.png"
    )
    ...
    fig, _ = plot_control_simulation_5dof(
        ...
        title="PID a gains flous dynamiques - bras 5DDL spatial",
        action_ylabel="N.m",
