"""Run computed-torque PID control on the dynamic 4-DOF arm."""
...
def main() -> int:
    ...
    output_path = ROOT / "results" / "figures" / "step_23_pid_dynamic_4dof.png"
    ...
    fig, _ = plot_control_simulation_4dof(
        ...
        title="Controle PID dynamique - bras 4DDL spatial",
        action_ylabel="N.m",
    )
