"""Run fuzzy gain-scheduled computed-torque PID on the dynamic 6-DOF arm."""
...
def main() -> int:
    ...
    output_path = (
        ROOT / "results" / "figures" / "step_37_pid_fuzzy_gain_dynamic_6dof.png"
    )
    ...
    fig, _ = plot_control_simulation_6dof(
        ...
        title="PID a gains flous dynamiques - bras 6DDL spatial",
        action_ylabel="N.m",
