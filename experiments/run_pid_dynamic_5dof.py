"""Run computed-torque PID control on the dynamic 5-DOF arm."""
...
def main() -> int:
    ...
    output_path = ROOT / "results" / "figures" / "step_28_pid_dynamic_5dof.png"
    ...
    fig, _ = plot_control_simulation_5dof(
        ...
        title="Controle PID dynamique - bras 5DDL spatial",
        action_ylabel="N.m",
    )
